...
const lookups = {
  ...
  backgroundDetail: { id: 1, name: 'Благородный', granted_skills: [] },
}
...
describe('StepReview', () => {
  ...
  it('uses manual HP gains for manual mode', () => {
    renderStep({ hp_mode: 'manual', manual_hp: { 2: 4, 3: 7 } })
